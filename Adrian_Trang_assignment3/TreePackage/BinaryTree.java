...
public class BinaryTree<T> implements BinaryTreeInterface<T>
{
    ...
    private void privateSetTree(T rootData,
        ...
        if ((leftTree != null) && !leftTree.isEmpty()) {
            ...
            leftTree.root.linkSubtreeThreadOut(root);
        ...
        if ((rightTree != null) && !rightTree.isEmpty()) {
            ...
            rightSubtreeRoot.setParent(root);  // ADD CODE TO SET THE PARENT OF THE RiGHT CHILD
            root.setThread(rightSubtreeRoot.getLeftmostInSubtree()); // SET THE THREAD OUT OF THE ROOT
...
//      by one that uses threads
    private class InorderIterator implements Iterator<T> {
        ...
        public T next() {
                ...
                // Follow thread to the in-order successor
